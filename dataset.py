...
class DatasetManager():
    ...
    def load_all_data(self):
        ...
        self.train_data_list, self.train_label_list, self.train_label_indices = self.__read_DCASE_csv_file(
            self.train_csv_filepath, "train")
        self.test_data_list, self.test_label_list, self.test_label_indices = self.__read_DCASE_csv_file(
            self.test_csv_filepath, "test")
        ...
        if os.path.isfile(filename):
            ...
            for i in range(len(self.audio_files)):
                ...
                if feature_index == 0:
                    ...
                    mel_specs.append(ap.extract_mfcc_spectrogram_for_left_and_right_channel(wav_name))
                elif feature_index == 10:
                    mel_specs.append(ap.extract_mfcc_spectrogram_for_hpss(wav_name))
    ...
    def prepare_data(self, train_indices, test_indices, train_only, train_csv="train_dataset.csv",
        ...
        with open(csv_file, 'r') as f:
            ...
            if len(content)==1:
                for line in content:
                    ...
                    datapath = os.path.join(x_row[0])  # first column in the csv : file names
